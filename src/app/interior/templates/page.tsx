      ...
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <h1 className="text-3xl font-extrabold text-gray-900">Interior Templates</h1>
            <p className="text-slate-500 mt-1">Standardize interior fit-out workflows with reusable project blueprints.</p>
          </div>
