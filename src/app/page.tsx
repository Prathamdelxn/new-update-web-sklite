...
const navLinks = [
  ...
  { label: 'Why SkyStruct Lite', href: '#results' },
];
...
const faqs = [
  ...
  ['Can SkyStruct Lite work across multiple projects?', 'Yes. Your workspace gives leadership a portfolio-level view while each project team gets a focused space for its own documents, progress and workflows.'],
    ...
    <div className="min-h-screen overflow-hidden bg-[#f7f9fc] text-slate-900">
      <header className={`fixed inset-x-0 top-0 z-50 transition-all duration-300 ${scrolled ? 'border-b border-white/10 bg-[#07172b]/90 shadow-xl shadow-slate-950/15 backdrop-blur-xl' : 'bg-transparent'}`}>
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-8">
          <Link href="/" className="flex items-center gap-2.5 text-xl font-bold tracking-tight text-white" aria-label="SkyStruct Lite home">
            <span className="grid size-8 place-items-center rounded-lg bg-cyan-300 text-sm text-[#08203b] font-extrabold">S</span> SKYSTRUCT <span className="text-cyan-300">LITE</span>
          </Link>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="relative mx-auto mt-16 max-w-6xl rounded-2xl border border-white/15 bg-white/[.06] p-2 shadow-2xl shadow-black/30 backdrop-blur-sm sm:p-3">
              <div className="overflow-hidden rounded-xl bg-[#f4f8fc] p-3 sm:p-5">
                <div className="mb-4 flex items-center justify-between"><div className="flex items-center gap-2"><span className="size-2 rounded-full bg-rose-400" /><span className="size-2 rounded-full bg-amber-400" /><span className="size-2 rounded-full bg-emerald-400" /><span className="ml-3 hidden rounded-md bg-slate-200 px-12 py-1 text-[10px] text-slate-400 sm:block">workspace.skystructlite.com / overview</span></div><div className="rounded-lg bg-slate-900 px-2.5 py-1 text-[10px] font-bold text-cyan-300">LIVE WORKSPACE</div></div>
                <div className="grid gap-4 lg:grid-cols-[176px_1fr]">
                  <aside className="hidden rounded-xl bg-[#0c2440] p-4 text-slate-300 lg:block"><p className="mb-7 text-sm font-bold tracking-tight text-white">SKYSTRUCT <span className="text-cyan-300">LITE</span></p>{['Overview', 'Projects', 'Workflows', 'Documents', 'Team'].map((item, index) => <div key={item} className={`mb-1 rounded-lg px-3 py-2 text-xs ${index === 0 ? 'bg-cyan-300 font-bold text-[#0c2440]' : ''}`}>{item}</div>)}<div className="mt-12 rounded-lg border border-white/10 bg-white/5 p-3"><p className="text-[10px] text-slate-400">Monthly health</p><p className="mt-1 text-xl font-bold text-white">86<span className="text-sm text-cyan-300">/100</span></p></div></aside>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-12 border-b border-white/10 pb-12 md:grid-cols-[1.5fr_repeat(3,1fr)]">
            <div className="max-w-xs">
              <Link href="/" className="flex items-center gap-2.5 text-xl font-bold tracking-tight text-white" aria-label="SkyStruct Lite home"><span className="grid size-8 place-items-center rounded-lg bg-cyan-300 text-sm text-[#08203b] font-extrabold">S</span> SKYSTRUCT <span className="text-cyan-300">LITE</span></Link>
